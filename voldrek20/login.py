...
def tela_cadastro():
    ...
    e_nome = Entry(frame_baixo, width=25, justify='left', font=('', 15), highlightthickness=1, relief=SOLID)
    e_nome.place (x=14, y=110)

    l_c_senha = Label(frame_baixo, text='confirmar  senha *' , anchor=NW , font=('Ivy 10') ,bg=co1 , fg=co4)
    l_c_senha.place(x=10 , y=140)
    e_nome = Entry(frame_baixo, width=25, justify='left', font=('', 15), highlightthickness=1, relief=SOLID)
    e_nome.place (x=14, y=160)

    b_confirmar = Button(frame_baixo, command='', text='Confirmar' ,width=10,height=2, anchor=NW , font=('Ivy 8 bold') ,bg=co2 , fg=co1, relief=RAISED, overrelief=RIDGE)
